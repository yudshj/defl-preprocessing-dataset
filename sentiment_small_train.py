...
x_train_path = './data/sentiment140_x_train.csr.npz'
y_train_path = './data/sentiment140_y_train.npy'
x_test_path = './data/sentiment140_x_test.csr.npz'
y_test_path = './data/sentiment140_y_test.npy'
batch_size = 1024
shuffle_train = True
repeat_train = False
